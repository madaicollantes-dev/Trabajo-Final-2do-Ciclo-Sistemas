...
EMAIL_USER = "tumail@gmail.com"          #Colocar el correo desde el que enviaras las alertas
EMAIL_PASS = "**** **** **** ****"           #Colocar la contraseña de la API (no la del correo)
EMAIL_DESTINO = "correoprofe@upc.edu.pe"      #Colocar el correo del profe
...
IP_MAC_CONFIANZA = {
    ...
    "192.168.X.Y": "a3:b2:c1:d5:e4:f3", #Reemplazar por la ip y mac de su laptop o PC desde la que ejecutaran el codigo
...
PING_SERVIDORES_DEFECTO = [
    ("Servidor AD",   "192.168.X.X"),
    ("Servidor WEB",  "192.168.X.Y"),
